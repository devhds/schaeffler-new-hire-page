...
import { VideoFullScreenTypes } from "@/payload-types";

const VideoFullScreen: React.FC<VideoFullScreenTypes> = ({
  video,
  copy,
  anchorNavigation,
  previewImage,
      ...
      <AnimatePresence>
        ...
        >
          ...
          >
            ...
            >
              <PlayIcon
                colorCircle={fullConfig.theme.colors.primary["white"]}
                colorPlay={fullConfig.theme.colors.primary["soft-black"]}
              />
            </motion.div>
          </motion.div>
          <motion.div
