          ...
          >
            ...
            >
              <LabelText
                ...
                size="small"
                color={
                  menuIsOpen ? "text-primary-soft-black" : "text-primary-white"
                }
              />
            </motion.div>
          </div>
            ...
            {navigationLinks.map((link) => {
              return (
                <div
                  ...
                  className={`relative ${currentSection === link.slug ? "text-primary-soft-black" : "text-primary-carbon-grey-100"} flex w-full justify-start border-b-[1px] border-primary-carbon-grey-20 py-4`}
                  key={link.id + "mobile-version"}
                  onClick={(e) => handleScrollTo(e, link.slug)}
                >
                  <LabelText
                    text={link.title}
                    size="medium"
