...
import { QuotesTypes } from '@/payload-types'

export interface QuotesProps extends QuotesTypes {
  isLocatedInTabBlock?: boolean
}

const Quotes: React.FC<QuotesProps> = ({ image, text, authorInfo, isLocatedInTabBlock }) => {
  return (
    <GridColumnsLayout
