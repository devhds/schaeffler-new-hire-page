...
import { ParallaxTextTypes } from '@/payload-types'

export interface ParallaxTextProps extends ParallaxTextTypes {
  className?: string
  isFooter?: boolean
}

const ParallaxText: React.FC<ParallaxTextProps> = ({ text, className, isFooter = false }) => {
