...
const IconLinks = ({
  ...
  const isExternalHref = isDownloadLink
    ? null
    : typeof href === "string" && true && href.indexOf("http") === 0;
    ...
    <>
      ...
      >
        <Link
          href={
            href && typeof href === "string"
              ? href
              : typeof href === "object" && href !== null && "slug" in href
                ? `/${href.slug}`
                : "/"
          }
        ...
        >
          ...
          >
            {isDownloadLink ? (
              <DownloadIcon color={fullConfig.theme.colors.primary["green"]} />
            ) : (
              <Icon color={fullConfig.theme.colors.primary["green"]} />
            )}
          </motion.span>
          <motion.span
            className="absolute flex items-center justify-center px-2.5 py-2.5 xl:h-buttonHeight xl:w-buttonWidth ul:h-[5.5rem] ul:w-[5.5rem]"
          ...
          >
            {isDownloadLink ? (
              <DownloadIcon color={fullConfig.theme.colors.primary["white"]} />
            ) : (
