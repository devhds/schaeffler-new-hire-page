...
const Quotes = ({ image, text, author }: InterfaceProps) => {
    return (
        <div className="sm:px-8 sm:py-12 md:py-[60px] md:pl-[9.25rem] md:pr-12 lg:py-20 lg:pl-[13rem] lg:pr-12 xl:py-20 xl:pl-[13rem] xl:pr-20 xs:px-6 xs:py-12 ul:py-20 ul:pl-[13rem] ul:pr-20">
            <div className="flex flex-row sm:flex-col sm:gap-y-6 md:gap-x-6 lg:gap-x-8 xl:gap-x-8 xs:flex-col xs:gap-y-6 ul:gap-x-8">
                {image !== '' && (
                    <Image
                        className="rounded-full sm:h-[9.75rem] sm:w-[9.75rem] md:h-[8.438rem] md:w-[8.438rem] lg:h-[11.688rem] lg:w-[11.688rem] xl:h-[11.688rem] xl:w-[11.688rem] xs:h-[9.75rem] xs:w-[9.75rem] ul:h-[11.688rem] ul:w-[11.688rem]"
                        src={testImage}
                        alt="quote_image"
                    />
                )}
