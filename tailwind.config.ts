  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'h6-ul': ['2rem', '150%'],
        // DISPLAY LARGE TEXT
        'display-large-xs': ['clamp(3.75rem, 3.75rem + 3.33vw, 5rem)', '1'],
        'display-large-sm': ['clamp(5rem, 0.06rem + 13.15vw, 7.5rem)', '1'],
        'display-large-md': ['clamp(5.875rem, -0.22rem + 10.7vw, 8.125rem)', '1'],
        'display-large-lg': ['clamp(7.5rem, -4.18rem + 15.07vw, 9.375rem)', '1'],
        'display-large-xl': ['clamp(9.375rem, -0.06rem + 10.42vw, 18.75rem)', '1'],
        'display-large-ul': ['18.75rem', '1'],
        // DISPLAY NORMAL TEXT
        'display-normal-xs': ['clamp(2.25rem, 2.25rem + 1vw, 2.625rem)', '119%'],
        'display-normal-sm': ['clamp(2.625rem, 0.15rem + 6.57vw, 3.875rem)', '119%'],
        'display-normal-md': ['clamp(2.625rem, -0.76rem + 5.98vw, 3.875rem)', '111%'],
        'display-normal-lg': ['clamp(3.875rem, -0.019rem + 5.02vw, 4.5rem)', '111%'],
        'display-normal-xl': ['clamp(4.5rem, -0.003rem + 5.003vw, 9rem)', '111%'],
        'display-normal-ul': ['9rem', '1'],
        // BODY TEXT LARGE
        'body-large-xl': ['clamp(1.125rem, 1.25vw, 2.25rem)', '156%'],
        'body-large-ul': ['2.25rem', '156%'],
        // BODY TEXT MEDIUM
        'body-medium-xl': ['clamp(1rem, -0.624rem + 1.80vw, 2.625rem)', '156%'],
        ...
        'quotes-sm-md': ['clamp(1.75rem, 1rem + 1.97vw, 2.125rem)', '133%'],
        'quotes-lg': [
        ...
        'title-ul': ['3.5rem', '143%'],
        // PROMOTION
        'promotion-xs': ['clamp(2.5rem, 14.3vw - 0.8rem, 4.5rem)', '104%'],
